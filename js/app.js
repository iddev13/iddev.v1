...
let myIntroSlider = new Swiper('.intro-slider', {
    // Навигация
    // Стрелки
    navigation: {
...
// Инициализация слайдера
let myIntroMiniSlider = new Swiper('.intro-mini-slider', {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const cursor = document.getElementById('cursor'),
        ...
        navElem = document.querySelectorAll('.nav-elem')
...
window.addEventListener('scroll', function () {
    ...
    if (window.innerWidth > 768) {
        document.querySelectorAll('.section').forEach(function (el, i) {
            if (el.offsetTop - document.querySelector('.header__nav').clientHeight - 280 <= scrollDistance) {
